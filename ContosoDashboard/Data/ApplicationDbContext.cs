...
public class ApplicationDbContext : DbContext
{
    ...
    public DbSet<DocumentScanJob> DocumentScanJobs { get; set; } = null!;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DocumentScanJob>()
    ...
    private void SeedData(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<User>().HasData(
            ...
            new User
            {
                ...
                AvailabilityStatus = AvailabilityStatus.Available,
                CreatedDate = seededAt.AddDays(1),
                EmailNotificationsEnabled = true,
                InAppNotificationsEnabled = true
            },
            new User
            {
                ...
                AvailabilityStatus = AvailabilityStatus.Available,
                CreatedDate = seededAt.AddDays(2),
                EmailNotificationsEnabled = true,
                InAppNotificationsEnabled = true
            },
            new User
            {
                ...
                AvailabilityStatus = AvailabilityStatus.Available,
                CreatedDate = seededAt.AddDays(3),
                EmailNotificationsEnabled = true,
                InAppNotificationsEnabled = true
            }
        );
        ...
        modelBuilder.Entity<Project>().HasData(
            new Project
            {
                ...
                ProjectManagerId = 2,
                StartDate = seededAt.AddDays(-30),
                TargetCompletionDate = seededAt.AddDays(60),
                Status = ProjectStatus.Active,
                CreatedDate = seededAt.AddDays(-30),
                UpdatedDate = seededAt.AddDays(2)
            }
        );
        ...
        modelBuilder.Entity<TaskItem>().HasData(
            new TaskItem
            {
                ...
                DueDate = seededAt.AddDays(-20),
                AssignedUserId = 4,
                CreatedByUserId = 2,
                ProjectId = 1,
                CreatedDate = seededAt.AddDays(-30),
                UpdatedDate = seededAt.AddDays(-20)
            },
            new TaskItem
            {
                TaskId = 2,
                ...
                DueDate = seededAt.AddDays(5),
                AssignedUserId = 4,
                CreatedByUserId = 2,
                ProjectId = 1,
                CreatedDate = seededAt.AddDays(-25),
                UpdatedDate = seededAt.AddDays(2)
            },
            new TaskItem
            {
                ...
                DueDate = seededAt.AddDays(10),
                AssignedUserId = 4,
                CreatedByUserId = 2,
                ProjectId = 1,
                CreatedDate = seededAt.AddDays(-20),
                UpdatedDate = seededAt.AddDays(-20)
            }
        );
        ...
        modelBuilder.Entity<ProjectMember>().HasData(
            new ProjectMember
            {
                ...
                UserId = 3,
                Role = "TeamLead",
                AssignedDate = seededAt.AddDays(-30)
            },
            new ProjectMember
            {
                ProjectMemberId = 2,
        ...
        modelBuilder.Entity<Announcement>().HasData(
            new Announcement
            {
                ...
                CreatedByUserId = 1,
                PublishDate = seededAt,
                ExpiryDate = seededAt.AddDays(30),
                IsActive = true
            }
        );
    }
